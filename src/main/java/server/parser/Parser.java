...
public class Parser {
    public static Object Parse(byte[] statement) throws Exception {
        ...
        try {
            ...
            if (!"".equals(next)) {
                ...
                statErr = new RuntimeException("Invalid statement:" + String.valueOf(errStat));
            }
        } catch (Exception e) {
            e.printStackTrace();
            byte[] errStat = tokenizer.errStat();
    ...
    private static boolean isLogicOp(String logicOp) {
        return ("and".equals(logicOp)||"or".equals(logicOp));
    }
    ...
    private static boolean isCmpOp(String cmpOp) {
        return (">".equals(cmpOp) || "=".equals(cmpOp) || "<".equals(cmpOp));
    }
